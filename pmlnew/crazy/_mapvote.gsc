init()
{
	...
	level.mapvotetext["MapVote"]		= &"^5Press ^0[ ^5{+attack} ^0]^5 For Voting";
	level.mapvotetext["TimeLeft"] 		= &"";
	level.mapvotetext["MapVoteHeader"] 	= &"^5Vote for Next Map";
...
notifySBoard()
{
	iprintln("^5Press^0 [ ^5TAB ^0]^5 For Scoreboard!");
	wait 6;
	iprintln("^5Press^0 [ ^5TAB ^0]^5 For Scoreboard!");
	wait 6;
	iprintln("^5Press^0 [ ^5TAB ^0]^5 For Scoreboard!");
...
CreateHud()
{
	...
	level.MapVoteHud[5].glowColor = (0.3, 0.3, 2.0);
	...
	level.MapVoteHud[9].glowalpha = 1;
	level.MapVoteHud[9].glowColor = (0.3, 0.3, 2.0);
	...
	level.MapVoteHud[6].glowalpha = 1;
	level.MapVoteHud[6].glowcolor = (0.3, 0.3, 2.0);
	...
	for (i = 0; i < level.MapVoteNames.size; i++)
	{
		...
		level.MapVoteNames[i].glowalpha = 1;
		level.MapVoteNames[i].glowColor = (0.3, 0.3, 2.0);
		...
		level.MapVoteVotes[i].glowalpha = 1;
		level.MapVoteVotes[i].glowColor = (0.3, 0.3, 2.0);
...
SetMapWinner(winner)
{
	...
	iprintlnbold("^5 Winner Map Is: ");
	iprintlnbold("^0" + mapname);
