...
addKillcamKiller(attacker,victim)
{
	...
	self.villain setPoint( "CENTER", "BOTTOM", -500, -120 ); 
	...
	self.versus.alpha = 0;
	self.versus setPoint( "CENTER", "BOTTOM", 0, -120 );  
	...
	self.victim setPoint( "CENTER", "BOTTOM", 500, -120 );
...
addKillcamTimer(camtime)
{
	if (! isDefined(self.fkc_timer))
	{
			...
			self.fkc_timer.x = 125;
			self.fkc_timer.alignX = "LEFT";
			self.fkc_timer.alignY = "TOP";
			self.fkc_timer.horzAlign = "LEFT";
			self.fkc_timer.vertAlign = "TOP";
			self.fkc_timer.y = 400;
			self.fkc_timer.sort = 1;
			self.fkc_timer.font = "big";
			self.fkc_timer.foreground = true;
			self.fkc_timer.color = (0.85,0.85,0.85);
			self.fkc_timer.glowalpha = 1;
			self.fkc_timer.glowcolor=(0.3, 0.3, 2.0);
			self.fkc_timer.hideWhenInMenu = true;
	}
	self.fkc_timer.y = 425;
